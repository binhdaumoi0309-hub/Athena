...
export interface BookingData { facilityId: string; specialtyId: string; doctorId: string; date: string; time: string; patientName: string; patientPhone: string; patientEmail: string; patientDob: string; patientGender: 'male' | 'female' | 'other' | ''; symptoms: string; }
